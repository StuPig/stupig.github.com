...
/*
 ...
 background: url("img/wx_tips.png") no-repeat;
...
*/
    ...
    var show = function(type){
        ...
        _el.innerHTML = '<div class="wxtips-doc">'
            ...
            + '<ol>'
                ...
                + (type!=='ios' ? '<li>选择在浏览器中打开<br>即可下载客户端<i style="margin-top:-23px; width: 47px; height: 47px; background-position: 0 -61px;">浏览器</i></li>' : '<li>选择在Safari中打开<br>即可下载客户端<i style="margin-top:-28px; width: 61px; height: 61px;">Safari</i></li>')
            + '</ol>'
    ...
    if(ua.indexOf('MicroMessenger') > -1){
        _body.addEventListener('click', function(e){
            if(e.target.className.indexOf('mj-down') >= 0){
                e.preventDefault();
                if(_el != null){
