...
__Profiler.prototype.elementCss = 'position:relative;margin:0 auto;top:' +
 ...
 */
__Profiler.prototype._createContainer = function(timingData) {
  var container = document.createElement('div');
  var header = this._createHeader();
  var button = this._createCloseButton();
  var browser = this._createBrowserInfo(timingData);
...
__Profiler.prototype._createBrowserInfo = function(timingData) {
    var p = document.createElement('p');

    p.innerHTML = 'UA：' + timingData.ua;
    p.style.cssText = this.cssReset + this.browserCss;
...
__Profiler.prototype._init = function(timingData) {
  ...
  this.container = this._createContainer(timingData);
